...
void soft_map_rational_interp(uint16_t *restrict out, uint16_t *restrict in, int w, int h, float cx0, float cy0, float cx1, float cy1) MAP_FUNC_ATTR;
void soft_map_butterfly(uint16_t *restrict out, uint16_t *restrict in, int w, int h, float cx0, float cy0) MAP_FUNC_ATTR;
void soft_map_lambda(uint16_t *out, uint16_t *in, int w, int h, float x0, float y0) MAP_FUNC_ATTR;
#endif
